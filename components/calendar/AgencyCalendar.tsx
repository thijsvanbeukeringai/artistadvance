  ...
  return (
    <>
      ...
      {pickedDate && (
        ...
        >
          <div className="bg-white border border-ink-200 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-auto" onClick={(e) => e.stopPropagation()}>
            <header className="px-5 py-4 border-b border-ink-200 flex items-center justify-between sticky top-0 bg-white">
              ...
              <button type="button" onClick={() => setPickedDate(null)} className="text-xs text-ink-500 hover:text-ink-900 px-2 py-1 rounded">Sluiten</button>
            </header>
            <div className="p-5">
              <AgencyBookingPanel
                artists={artists}
